...
export const getCursosAll = (req: Request, res: Response) => {//metodo para obtener todos los cursos
    cursoModel.find() 
...
export const registerCurso  = (req: Request, res: Response) => { //metodo para registrar un curso
